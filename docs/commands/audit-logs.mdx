...
```
 TIMESTAMP                 USER                OPERATION        IP ADDRESS
 2024-06-15T10:30:00Z      alice@acme.com      UserLogin        203.0.113.10
 2024-06-15T10:32:00Z      alice@acme.com      CreatedApiKey    203.0.113.10
```
