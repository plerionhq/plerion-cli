...
```bash
plerion vulnerabilities exemptions get --profile-id <id> <exemption-id>
```
...
```bash
plerion vulnerabilities exemptions update --profile-id <id> <exemption-id> [--name <n>] [--reason <r>]
```

### exemptions delete

```bash
plerion vulnerabilities exemptions delete --profile-id <id> <exemption-id>
```
...
# Delete an exemption
plerion vulnerabilities exemptions delete --profile-id my-profile ex-abc123
```
